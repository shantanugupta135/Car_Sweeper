...
import { Home, Clock, BarChart3, User, Menu, X, Car, CreditCard, MessageSquare, Star, LogOut } from "lucide-react"
      ...
      >
        ...
        <div className="border-t border-border px-4 py-3 space-y-3">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-lg px-3 py-2.5 text-sm font-medium text-destructive bg-destructive/10 hover:bg-destructive/15 transition-colors active:scale-95"
          >
